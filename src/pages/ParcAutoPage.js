...
function ParcAutoPage() {
  ...
  const confirmDeleteVoiture = async () => {
    try {
      await api.deleteVoiture(confirmDelete);
  ...
  const handleSelect = (v) => {
    setSelectedId(v.IdAuto);
    setSelectedModello(v.IdModello ? v.IdModello.toString() : "0");
    setNewTarga(v.Targa);
    setNewRottamato(v.Rottamato === 1);
    setNewPriorite(v.Priorite || "R");
    setMessage("");
  };
              ...
              {voitures.map((v) => (
                ...
                >
                  ...
                  <td>
                    <span
                      className={
                        "priorite-badge priorite-" +
                        (v.Priorite || "r").toLowerCase()
                      }
                    >
                      {v.Priorite === "R"
                        ? "Riva"
          ...
          <div className="marques-form-row">
            ...
            <div className="parc-checkbox-wrapper">
              ...
              <label htmlFor="chkRottamato" className="parc-checkbox-label">
                {newRottamato ? "OUI — hors service" : "NON — disponible"}
              </label>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <p style={{ color: "#666", marginBottom: 24 }}>
              Etes-vous sur de vouloir supprimer cette voiture ? Cette action est
              irreversible.
            </p>
